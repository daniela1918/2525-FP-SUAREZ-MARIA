...
# Lista de nombres para las ciudades
...
for ciudad_idx, ciudad in enumerate(temperaturas):  # Recorre ciudades
    print(f"\nPromedios en {ciudades[ciudad_idx]}:")
    for semana_idx, semana in enumerate(ciudad):  # Recorre semanas
        suma_temperaturas = sum([fahrenheit_a_celsius(dia["temp"]) for dia in semana])  # Convertir y sumar
        promedio = suma_temperaturas / len(semana)  # Promedio semanal
